import {Card, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, useTheme,} from "@mui/material";
                                        ...
                                        <TableRow hover key={transaction.id}>
                                            ...
                                            <TableCell>
                                                <Typography
                                                    ...
                                                    noWrap
                                                >
                                                    {`${isSent ? transaction.fromAfterBalance : transaction.toAfterBalance} ${getCurrencyLabel(account.currency)}`}
                                                </Typography>
                                            </TableCell>
